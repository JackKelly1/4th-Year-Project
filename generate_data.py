# Property of GNPY – Telecom InfraProject (TIP), OOPT/PSE
# Code from line 470 onwards, Author: Jack Kelly
# Addition of lines 207-209 to randomise launch power
...
#     return destination.snr_01nm, input_power
...
def snr_breakdown_file_create():
    with open('snr_breakdown.csv', 'w', newline='') as file:
        writer = csv.writer(file)

def snr_breakdown_write_row(elements):
    with open('snr_breakdown.csv', 'a+', newline='') as file:
        writer = csv.writer(file)
        writer.writerow(elements)

    
# Comment in/out the appropriate lines of code depending on the data generation requirement
...
instantiateWriteFile('myfile.csv')
file_path = 'myfile.csv'
ch_list = [1]*5+[0]*35
ch_list_np = np.array(ch_list)
currentChannels = channelSetter(ch_list_np)
input_power = 0.4
input_power, values, GSNR = transmission_main_example()
print(values)
...
### End of single iteration test ###




### Finding optimum launch power ###
...
# input_power = -4.0
# for i in range(80):
#     values, input_power, GSNR = transmission_main_example()
#     GSNRs.append(GSNR)
#     input_powers.append(input_power)
#     input_power += 0.1
# file_path = "optimum_power.csv"
# add_row_of_data(file_path, input_powers)
# add_row_of_data(file_path, GSNRs)
...
# ### Finding OSNRs and NLIs

# channel_no = 40
# data_number = 10000
# iteration_no = data_number//channel_no
# labels = createLabels(channel_no)
# # snr_breakdown_file_create()
# ch_list = [1]*channel_no
# ch_list_np = np.array(ch_list)
# currentChannels = channelSetter(ch_list_np)
# input_power, OSNR_ASE, SNR_NLI, GSNR = transmission_main_example()
# for i in range(10):
#     print('--------------')
# snr_breakdown_write_row(OSNR_ASE)
# snr_breakdown_write_row(SNR_NLI)
# snr_breakdown_write_row(GSNR)
...
# iteration_no = data_number//channel_no
# labels = createLabels(channel_no)
# file_path = (f'network1_{data_number}_TEST.csv')
# instantiateWriteFile(file_path)


# for cur_Channel_Number in range(0, channel_no):
# # for cur_Channel_Number in range(1):
#     for iteration in range(1,iteration_no+1):
# #     for iteration in range(1):
#         print('-------------------------------')
#         print('Row of data number: ', (cur_Channel_Number*iteration_no + iteration))
#         print('-------------------------------')
#         ch_list = [1]*channel_no
...
### Automate data generation in blocks ###

# timings = []
# channel_no = 40
# data_numbers = [200, 400, 800, 1200, 1600, 2000, 2400]
# for data_number in data_numbers:
#     start_time = time.time()
#     iteration_no = data_number//channel_no
#     labels = createLabels(channel_no)
#     file_path = (f'network2_{data_number}.csv')
#     instantiateWriteFile(file_path)
